...
int Tcl_AppInit(Tcl_Interp *interp)
{
  ...
  printf("vtkTclApplicationInitTclTk start");
  vtkTclApplicationInitTclTk(interp, relative_dirs);
  printf("vtkTclApplicationInitTclTk end");
...
# include "vtktcl_static_packages.h"
  ...
  static char script[] =
    ...
    "}\n";
  /*static char script[] = "\
  foreach dir [list \"/usr/local/lib/vtk/tcl\" [file join [file join [file dirname [file dirname [info nameofexecutable]]] Wrapping] Tcl] [file join [file join [file dirname [info nameofexecutable]] Wrapping] Tcl]] { \n\
      if {[file isdirectory $dir]} { \n\
          lappend auto_path $dir \n\
      } \n\
  } \n\
